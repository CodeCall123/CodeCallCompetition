...
router.get('/competitions', async (req, res) => {
  try {
    const competitions = await Competition.find({}, 'name description status reward points image languages types startDate endDate');
...
router.post('/competitions/:id/becomeJudge', async (req, res) => {
  const { id } = req.params;
...
router.post('/:id/mergePR', checkRole('judge'), async (req, res) => {
  const { id } = req.params;
